...
[![v1.2](https://img.shields.io/badge/version-1.2-blue.svg)](https://github.com/zx2592/douban_backup)
...
*   **完整数据**：
    ...
    *   **包含标签**：保留您打的个人标签。
*   **美化 Excel 导出** (v1.2 新增)：
    *   **分页存储**：总览 + 电影/书籍/音乐/游戏各一个 Sheet。
    *   **状态分组**：看过/在看/想看 用彩色标题行分隔，一目了然。
    *   **星级评分**：数字评分转为直观的星级符号显示。
    *   **可点击链接**：豆瓣条目链接可直接点击跳转。
    *   **统计总览**：首页展示各类别/各状态的数据汇总。
*   **防反爬**：
    *   内置智能延迟和重试机制。
    *   支持断点续传（基于页码）。
